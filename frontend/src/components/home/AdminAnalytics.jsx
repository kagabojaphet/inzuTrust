        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="bg-white p-8 rounded-lg border border-slate-200 shadow-xl shadow-slate-200/40 flex flex-col h-full hover:shadow-2xl transition-all duration-500">
            <div className="flex justify-between items-center mb-10">
              <h3 className="text-2xl font-black text-slate-900 tracking-tight">{t("adminAnalytics.overview")}</h3>
              <span className="bg-brand-blue-bright text-white px-4 py-1.5 rounded-lg text-sm font-bold shadow-sm">{t("adminAnalytics.monthly")}</span>
            </div>
            <div className="w-full h-48 relative flex items-end">
              ...
              <div className="w-full h-full ml-8 border-l border-b border-slate-100 relative overflow-hidden">
                ...
                <div className="absolute top-10 left-1/2 bg-white shadow-xl border border-slate-100 p-2 rounded-lg text-center">
                  <p className="text-[10px] font-black text-slate-400 uppercase">{t("adminAnalytics.ratings")}</p>
          ...
          <div className="bg-white p-8 rounded-lg border border-slate-200 shadow-xl shadow-slate-200/40 flex flex-col h-full hover:shadow-2xl transition-all duration-500">
            <span className="bg-brand-blue-bright text-white px-4 py-1.5 rounded-lg text-sm font-bold w-fit mb-8 shadow-sm">{t("adminAnalytics.newVotes")}</span>
          ...
          <div className="bg-white p-8 rounded-lg border border-slate-200 shadow-xl shadow-slate-200/40 flex flex-col h-full hover:shadow-2xl transition-all duration-500">
            <div className="flex justify-between items-start mb-8">
              <h3 className="text-2xl font-black text-slate-900 tracking-tight">{t("adminAnalytics.scoreHistory")}</h3>
            ...
            <div className="flex items-center gap-4 mb-8 p-4 bg-slate-50 rounded-lg border border-slate-100">
              ...
              <p className="text-xs font-black text-slate-900 uppercase tracking-wider">{t("adminAnalytics.verifiedStatus")}</p>
            </div>
