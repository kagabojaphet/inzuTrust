// model/agreement.js — Updated with terminationRequest field
...
const Agreement = sequelize.define("Agreement", {
  ...
  leaseApplicationId: { type: DataTypes.UUID, allowNull: true  },
  ...
  status: {
    type: DataTypes.ENUM("draft","pending_signature","signed","expired","terminated","termination_requested"),
    defaultValue: "draft",
  },
  ...
  // ── Termination flow ─────────────────────────────────────────────────────
  // Stored as JSON string: { requestedBy, requestedByRole, reason, proposedDate, requestedAt, disputed?, counterReason? }
  terminationRequest: { type: DataTypes.TEXT, allowNull: true },
